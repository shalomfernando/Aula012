...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
        ...
        <body>
            ...
            <div id="main" class="container">
                ...
                <button class="btn btn-primary" type="submit" name="command" value="ListarPaisBusca">
                    <span class="glyphicon glyphicon-search"></span>
                        ...
                        <div class="col-md-3">
                            <a href="CriarPais.jsp" class="btn btn-primary pull-right h2">Novo Cliente</a>
                        </div>
                    </div>
                    <!-- /#top -->
                </form>
                            ...
                            <tbody>
          					<c:forEach var="pais" items="${lista }">
                                       <tr>
                                            ...
                                            <td class="actions">
                                                <a class="btn btn-success btn-xs" href="controller.do?command=VisualisarPais&id=${pais.id }">Visualizar</a>
